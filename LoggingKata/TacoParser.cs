    ...
    public class TacoParser
    {
        ...
        public ITrackable Parse(string line)
        {
            ...
            if (cells.Length < 3)
            {
                ...
                logger.LogError("Cells should be at least 3.");
                return null; 
            }

            // DONE-TODO: Grab the latitude from your array at index 0
            // You're going to need to parse your string as a `double`
            // which is similar to parsing a string as an `int`

            var parsedLatitude = double.Parse(cells[0]);

            // DONE-TODO: Grab the longitude from your array at index 1
            // You're going to need to parse your string as a `double`
            // which is similar to parsing a string as an `int`

            var parsedLongitude = double.Parse(cells[1]);
